...
for recette in liste_recettes_sauvegardees:
    ...
    recette["ingredients_correspondants"] = [i for i in noms_ingredients if i in mes_ingredients]
    recette["ingredients_manquants"] = [i for i in noms_ingredients if i not in mes_ingredients]
...
liste_recettes_sauvegardees.sort(key=lambda x: x["score_correspondance_ingredients"], reverse=True)
